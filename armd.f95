...
! Defining variables
!
integer::natom,ntime,nprint,i,j,k,ncont,ilts,itime,idd,istart
  ...
  real::dseed,temp,epsln,sigma,Penergy,Kenergy,Tenergy,expTenergy,xbox,ybox,zbox,mar,kb,rcut,dx,dy,dz,dd,xx,yy, &
        ...
        avgKenergy, avgtemp, avgPenergy2, avgKenergy2, avgTenergy2, avgtemp2, sdPenergy, sdKenergy, sdTenergy, sdtemp
...
! write data
!
  write(20,500) istart,ilts,natom,ntime,nprint,epsln,sigma,temp,expTenergy,mar,kb,rcut,dt,xbox,ybox,zbox,gout,eout, &
                xout,ipdb,fpdb
...
!     avgtemp2     = avgtemp2/ntime
     sdPenergy    = sqrt((ntime*avgPenergy2 - avgPenergy*avgPenergy)/ntime**2)
     sdKenergy    = sqrt((ntime*avgKenergy2 - avgKenergy*avgKenergy)/ntime**2)
     sdtemp       = sqrt((ntime*avgtemp2 - avgtemp*avgtemp)/ntime**2)
...
!
  do i = 1,natom-1
    ...
    fzi = 0.0
    ii = i + 1
    do j = ii,natom     ! To save computer time :: Paralell computation
      dx = x(j) - xi
      dy = y(j) - yi
      dz = z(j) - zi
!
